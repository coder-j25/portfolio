            ...
            <div className="pt-12">
                <div className="flex flex-col items-center bg-white md:flex-row md:max-w-xl hover:bg-gray-100 dark:border-gray-700 dark:bg-gray-800 dark:hover:bg-gray-700 mt-16 m-auto">
                    ...
                    <div className="flex flex-col justify-between p-4 leading-normal">
                        ...
                        <p className="mb-3 font-normal text-gray-700 dark:text-gray-400">I like to problem solve and design solutions which leave an impact...<span>
                            <Link
                                to="/aboutMe"
                                className="introSpan">
                                About Me</Link></span></p>
                    </div>
                </div>
            </div>
            <br />
            <div className="bg-gray-300 pb-10 pt-10">
                <Projects />
            </div>
        </>
    )
